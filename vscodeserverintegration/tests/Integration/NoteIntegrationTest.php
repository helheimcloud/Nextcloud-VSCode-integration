...
namespace OCA\VSCodeServerIntegration\Tests\Integration\Controller;

use OCP\AppFramework\App;
use OCP\IRequest;
use PHPUnit\Framework\TestCase;

use OCA\VSCodeServerIntegration\Db\Note;
use OCA\VSCodeServerIntegration\Db\NoteMapper;
...
class NoteIntegrationTest extends TestCase {
	...
	public function setUp(): void {
		$app = new App('vscodeserverintegration');
